...
public class TestSpdxSourceFileParser {
	...
	private static final String CONJUNCTIVE = "  SPDX-License-Identifier:   "+APACHE_LICENSE_ID +
			" AND "+ MIT_LICENSE_ID + " AND "+LICENSE_REF_ID;
	private static final String COMPLEX = "SPDX-License-Identifier:((" + MIT_LICENSE_ID +
			" OR " + APACHE_LICENSE_ID + ") OR " + APACHE_LICENSE_ID + ")";
	private static final String COMPLEX_MULTI = "  SPDX-License-Identifier: ((" + MIT_LICENSE_ID +
